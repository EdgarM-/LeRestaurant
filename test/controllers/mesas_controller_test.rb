...
class MesasControllerTest < ActionController::TestCase
  ...
  test "should create mesa" do
    assert_difference('Mesa.count') do
      post :create, mesa: { : @mesa., : @mesa., cantidadPersonas: @mesa.cantidadPersonas, numero,: @mesa.numero, }
    end
  ...
  test "should update mesa" do
    patch :update, id: @mesa, mesa: { : @mesa., : @mesa., cantidadPersonas: @mesa.cantidadPersonas, numero,: @mesa.numero, }
    assert_redirected_to mesa_path(assigns(:mesa))
  end
